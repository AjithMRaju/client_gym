...
export const HeroLoading = ({ progress }) => {
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#dc2626] text-white"
    >
      <div className="flex flex-col items-center gap-4">
        ...
        <motion.h2
          ...
          className="text-4xl font-black md:text-7xl tracking-tighter "
        >
          YOUR <span className="text-red-200">BRAND</span>
        </motion.h2>
        ...
        <span className="text-xs  tracking-widest text-red-100 uppercase">
